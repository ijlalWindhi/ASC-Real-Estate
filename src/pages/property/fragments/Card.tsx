...
export default function Card({ price, description, image, button, bed, bath} : CardType) {
  return (
    <Box maxW={"100%"} px={3} py={3} rounded={"xl"} bgColor={"white"} _hover={{ boxShadow: "xl" }} overflow={"clip"} mx={"auto"}>
      ...
      <Text fontSize={"sm"} fontWeight={"normal"} w={"fit-content"} h={'6'} overflow={"clip"}>{description}</Text>
      <Flex mt={4} justifyContent={"space-between"}>
        ...
        <Flex alignItems={"center"}>
          <Icon as={BiBath} w={6} h={6} color={"blue.400"} bgColor={"blue.100"} p={1} mr={1} rounded={"full"}/>
